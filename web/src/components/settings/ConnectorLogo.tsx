...
// Monochrome marks (simple-icons), rendered white on the preset's brand
// color — same treatment providers use. mounts once in App;
// ConnectorLogo references symbols from it.
  ...
  return (
    <svg width="0" height="0" className="absolute" aria-hidden="true">
      <defs>
        ...
        <symbol id="clogo-atlassian" viewBox="0 0 24 24">
